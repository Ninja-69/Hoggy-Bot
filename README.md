...
## Community Updates
[hogy + Slash commands by Ninja](https://github.com/Pogy-Bot/Pogy/tree/eyum-contributions)

## About

Hogy is a discord bot Source Code Made By Ninj.69 Also, you can join the official [Hogy's Support Server](https://pogy.xyz/support) for assistance.
...
Hogy even has the following features on the website
...
- Built in TOP.gg API
 ...
 <h1 align="center">
  <a href="https://github.com/Ninja.69"><img src="https://i.imgur.com/On7mMNg.jpg["></a>
</h1>

**Webhooks: (for Developer)**
With Hogy You can even log everything using webhooks directly from the config file!

<h1 align="center">
  <a href="https://github.com/Ninja.69"><img src="https://i.imgur.com/vbGuLdL.jpg"></a>
</h1>
...
- AUTH_DOMAIN=Your Auth Domain (Ex. https://rushmc.fun or http://localhost:3000) no slash at the end.
...
MAIN CLIENT ID
yourdomain/thanks example https://rushmc.fun/thanks or http://localhost:3000/thanks
yourdomain/window example https://rushmc.fun/window or http://localhost:3000/window

AUTH CLIENT ID
yourdomain/callback example https://rushmc/callback or http://localhost:3000/callback
...
You can donate Hogy and make it stronger than ever [by clicking here](https://dsc.gg/itzmeninja)!

## Credits
- Ninja [DJS Rewrite] - [github.com/ninja.69](github.com/ninja.69)
